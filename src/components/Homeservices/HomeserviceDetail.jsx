...
const HomeserviceDetail = () => {
  ...
  return (
    <div className='w-full mx-auto px-4 sm:px-6 md:px-12 p-4 mb-8'>
      ...
      >
        <ArrowLeft className='w-4 h-4 mr-1' /> Back to Homeservices
      </Link>
      ...
      <div className='flex justify-end md:-mt-24 mt-8 px-4'>
